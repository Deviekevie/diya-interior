...
const Hero = () => {
  return (
    ...
    className='loading-logo'>DIYA MODULARS.</motion.div>
    <motion.div 
    initial={{y: "-500%"}}
    animate={{y: 0}}
    exit={{y: "-500%"}}
    ...
    <div className="hero-wrapper">
        <div className='hero-content'>
            ...
            >Crafting<span className='yellow'>Timeless</span> Interiors<br/>for Modern<span className='yellow'>Living.</span></motion.h1>
             <Link to='/contact' style={{textDecoration: 'none'}}><motion.div 
                initial={{opacity: 0}}
                animate={{opacity: 1}}
                transition={{duration: 1.2, delay: 2.8}}
            className='hero-cta'>
              <p className='cta-text'>Feel free to  <br/> reach out</p>
                <p className='arrow'> <AiOutlineArrowRight/></p>
            </motion.div></Link> 
        </div>
    </div>
